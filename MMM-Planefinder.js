...
Module.register("MMM-Planefinder", {
    ...
    getDom: function() {
        ...
        title.innerHTML = "Takeoffs are optinal.  Landings are mandatory.";
        ...
        // Add airport codes reference list
        if (this.config.airportCodes && this.config.airportCodes.length > 0) {
            var airportList = this.createAirportCodesList();
            wrapper.appendChild(airportList);
        }
    ...
    // Create airport codes reference list
    createAirportCodesList: function() {
        var listContainer = document.createElement("div");
        listContainer.className = "planefinder-airport-list";

        for (var i = 0; i < this.config.airportCodes.length; i++) {
            var airportItem = document.createElement("div");
            airportItem.className = "planefinder-airport-item";
            airportItem.innerHTML = this.config.airportCodes[i];
